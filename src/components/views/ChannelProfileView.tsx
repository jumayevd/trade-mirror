    ...
    <div className="space-y-8">
      ...
      <section>
        ...
        <div className="grid grid-cols-2 gap-3 md:grid-cols-3 xl:grid-cols-5">
          ...
          <Stat label={t("chan.stat.uzbImports")} value={fmtUSD(channel.uiT)} accent={COLORS.uzb}
            sub={t("chan.sub.uzbRecorded")} info={`Cumulative imports of HS ${channel.cmd} from ${channel.partner} as recorded by Uzbekistan. ${fmtUSDFull(channel.uiT)}.`} />
      ...
      <section>
        ...
        <div className="grid grid-cols-2 gap-3 md:grid-cols-3 xl:grid-cols-5">
          ...
          <Stat label={t("chan.stat.longestStreak")} value={`${channel.longestPosStreak} yr${channel.longestPosStreak === 1 ? "" : "s"}`}
